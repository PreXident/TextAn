 ...
 * Adam: This class is included into the project just to fix {@link #colorFromIndex(int, boolean)}.
 *
 * @author Andrea Francke, Olivier Clerc, modified by Vincent Levorato, fix by
 * Adam
...
public class BasicHypergraphRenderer<V, E> extends BasicRenderer<V, E> {
    ...
    /**
     * Construct a new basic hypergraph renderer that uses the basic hyperedge
     * and hypervertex renders.
     */
    ...
    /**
     * Returns for a non-negative index number a corresponding color. Different
     * indices result in human distinguishable colors. The color is available in
     * a bright and dark version. Colors are generated by spiraling down into
     * the middle of a color circle.
     *
...
//        }
    ...
    /**
     * Return the index of a hyperedge in a hypergraph. If the hyperedge is not
     * contained in the hypergraph, -1 is returned.
     *
