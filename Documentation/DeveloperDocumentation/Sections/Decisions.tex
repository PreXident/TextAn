...
This project is primary destined for policemen and their reports. They have very specific domain with things and people they register. We decided to create more general model, to enable its use and spread it into world of text recognizer. The model is detailed described also in Section \ref{sec:Database} about database.
