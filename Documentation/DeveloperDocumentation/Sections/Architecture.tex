...
\comment[Adam]{Adam}{Add overall overview figure.}
...
\comment[Adam]{Adam}{Add package overview.}
...
\comment[Adam]{Adam}{Add reference to package overview.}

\comment[Adam]{Adam}{Add modified pipeline schema.}
...
\comment[Adam]{Adam}{Add complete graph package schema.}
...
\comment[Adam]{Adam}{Add controller hierarchy.}
...
\comment[Adam]{Adam}{Add window hierarchy.}
