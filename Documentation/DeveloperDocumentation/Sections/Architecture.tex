%This section contains the system architecture
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% (80 char rule :D)
...
\comment[someone]{Petr}{Add small intro, 2 components ect.}
...
to implement JNI, because training is called as binary files and model is generated
...
\comment[Petr]{Petr}{Describe re-learning process, command inwoker}
...
\comment[Petr(& Adam)]{Petr}{Describe communication pattern between clint and server,
