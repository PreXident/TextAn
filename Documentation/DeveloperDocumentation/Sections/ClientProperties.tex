...
#path window height
path.wizard.height=586.0
#is path window maximized?
path.wizard.maximized=true
#path window width
path.wizard.width=865.0
#path window x-pos
path.wizard.x=295.0
#path window y-pos
path.wizard.y=60.0
...
#last directory with imported file
...
settings.view.height=225.0
#settings window width
settings.view.width=265.0
#settings window x-pos
settings.view.x=869.0
#settings window y-pos
settings.view.y=390.0
