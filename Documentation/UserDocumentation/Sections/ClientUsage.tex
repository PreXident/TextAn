...
On the first run of \textan{} client, users are promted to enter their username
...
The main window (see figure \ref{fig:MainWindow}) contains a menu bar with
...
file and load report which the processing was not finished, but was saved to continue
