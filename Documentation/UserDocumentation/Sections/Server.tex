...
Path of generated file, based on property file \comment{Ondrej}{something is missing here}
...
Optional parameter with heldout data in the described format \comment{Ondrej}{where it was described?}. If the heldout data
...
\comment{Ondrej}{What is the difference between lemma and raw\_lemma?}
