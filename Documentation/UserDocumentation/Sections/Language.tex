...
English. \comment{Ondrej}{Explicitly mention that only one language is supported
at once} There are two areas which depend on the selected language: named entity
